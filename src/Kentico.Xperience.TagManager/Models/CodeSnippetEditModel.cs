...
{
    public class CodeSnippetEditModel
    {
        ...
        public IEnumerable<int> ChannelID { get; set; } = Array.Empty<int>();
        [RequiredValidationRule]
        ...
        [RequiredValidationRule]
        [ObjectIdSelectorComponent(objectType: "cms.consent", Label = "Consent", Order = 5)]
        public IEnumerable<int> ConsentID { get; set; } = Enumerable.Empty<int>();
